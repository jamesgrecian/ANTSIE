...
The optimal number of environmental covariates to describe the habitat of each species were calculated using [Species-specific covariate selection](scripts/Species-specific covariate selection.R). The output of this script is a list with each element containing the model ranking table for each species.
